        ...
        <div className={`flex my-[70px] gap-[40px] w-full px-5 justify-around ${mwidth.isTabletPlusDevice?"flex-col-reverse":""}` }>
            ...
            <div className={`flex justify-center items-center  gap-[10px]  ${mwidth.isTabletPlusDevice ? "w-[100%]" : "w-[40%]"} flex-col`}>
                {[
                    ...
                    return (
                        <div key={index} ref={[ref, ref2, ref3][index]} className={` ${[inView, inView2, inView3][index] ? "visible animate-slideright1" : "invisible"} group hover:transform hover:scale-[105%] flex p-5 shadow-md  gap-[30px] items-center w-full min-h-[100px]`}>
